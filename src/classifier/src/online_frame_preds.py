...
sys.path.insert(0, join(ENV_HOME, "catkin_ws/src/classifier/src"))
sys.path.insert(0, join(ENV_HOME, "catkin_ws/src/classifier/src/utils"))
sys.path.insert(0, join(ENV_HOME, "catkin_ws/src/classifier/src/models"))
sys.path.insert(0, join(ENV_HOME, "catkin_ws/src/classifier/src/kernels"))
...
class OnlineTester:
    ...
    def __init__(self, in_topic, out_topic):
        ...
        training_path = join(ENV_HOME, 'Myhal_Simulation/trained_models', log_name)
...
if __name__ == '__main__':
    ...
    tester = OnlineTester("/velodyne_points", "/classified_points")
